...
public enum WSInputs implements Inputs
{
   ...
   // Manipulator Enums
   MAN_RIGHT_JOYSTICK_Y("Manipulator right Y", WSInputType.JS_JOYSTICK, new WsJSJoystickInputConfig(1, JoystickConstants.RIGHT_JOYSTICK_Y), true),
   MAN_RIGHT_JOYSTICK_X("Manipulator right X", WSInputType.JS_JOYSTICK, new WsJSJoystickInputConfig(1, JoystickConstants.RIGHT_JOYSTICK_X), true),
   MAN_LEFT_JOYSTICK_X("Manipulator left Y", WSInputType.JS_JOYSTICK, new WsJSJoystickInputConfig(1, JoystickConstants.LEFT_JOYSTICK_X), true),
